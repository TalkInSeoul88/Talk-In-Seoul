...
- **Pronunciation** — **모음(vowels)** (Jung’s audio + Record / Play me) and **자음(consonants)** are free. The first six 자음 (ㄱ ㄴ ㄷ ㄹ ㅁ ㅂ) have teacher clips; the rest say Audio coming soon. **음절(syllables)** is the full 140 CV chart; Play / Record need a class access code. The ㅏ and ㅑ rows (가나다라마바사아자차카타파하 / 갸냐댜랴먀뱌샤야쟈챠캬탸퍄햐, 28/140) have teacher clips; other vowel columns say Audio coming soon.
...
The 10 basic vowels and the first six consonants (**ㄱ ㄴ ㄷ ㄹ ㅁ ㅂ**) already use **Jung’s recordings**. The remaining 자음 and all 음절 files are not included yet; missing clips show **Audio coming soon**.
